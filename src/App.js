...
import TopNavBar from './pages/User/TopNavBar'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/userId/myApplication" element={<MyApplication />} />
        <Route path="/userId/explore" element={<Explore />} />
        <Route path="/userId/explore/viewdetails/:type" element={<JobDetail />} />
      </Routes>
    </BrowserRouter>
  );
}
